...
<head>
    ...
    <title>Warung Gilang Jaya 07 - Mie Ayam & Bakso Lezat</title>
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Roboto:wght@300;400;500&display=swap" rel="stylesheet">
    <style>
        /* CSS Styling - Perpaduan Hitam, Putih, Merah */
        body {
            font-family: 'Roboto', sans-serif;
            margin: 0;
            padding: 0;
            background-color: #ffffff; /* Putih untuk latar belakang utama */
            color: #000000; /* Hitam untuk teks utama */
            line-height: 1.6;
        }
        header {
            background-color: #e74c3c; /* Merah untuk header */
        ...
        nav {
            background-color: #000000; /* Hitam untuk navigasi */
            padding: 15px 0;
        }
        nav ul {
            list-style: none;
        ...
        nav ul li a {
            color: #ffffff; /* Putih untuk link nav */
        ...
        nav ul li a:hover {
            color: #e74c3c; /* Merah untuk hover */
        }
        .hero {
            background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); /* Gradient merah untuk hero */
            height: 400px;
            display: flex;
            align-items: center;
            justify-content: center;
            color: #ffffff; /* Putih untuk teks hero */
            text-align: center;
            font-family: 'Playfair Display', serif;
        }
        .hero h1 {
